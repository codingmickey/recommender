      ...
      <div className="max-w-7xl mx-auto p-4 px-20 rounded-xl border-2 border-orange-600/40 bg-orange-100/10 shadow-xl backdrop-filter backdrop-blur-lg transform duration-300 shadow-orange-500/25 py-12 flex flex-col items-center gap-8 w-full">
        ...
        <form className="w-3/4">
          <div className="mb-4">
            ...
            <div className="space-y-2">
              <label className="flex items-center">
                <input type="radio" name="campaignGoal" value="Convince to buy product" className="mr-2" required />
                Convince to buy product
              </label>
              <label className="flex items-center">
                <input type="radio" name="campaignGoal" value="Recover churned customers" className="mr-2" required />
                Recover churned customers
              </label>
              <label className="flex items-center">
                <input type="radio" name="campaignGoal" value="Teach a new concept" className="mr-2" required />
                Teach a new concept
              </label>

              <label className="flex items-center">
                <input type="radio" name="campaignGoal" value="Onboard users" className="mr-2" required />
                Onboard users
              </label>
              <label className="flex items-center">
                <input type="radio" name="campaignGoal" value="Share product updates" className="mr-2" required />
          ...
          <div className="mb-4">
            ...
            <select required id="brandTone" name="brandTone" className="w-full border rounded-md px-3 py-2">
